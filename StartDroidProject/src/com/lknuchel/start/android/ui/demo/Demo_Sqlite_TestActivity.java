...
//import com.lknuchel.start.android.io.sqlite.BarcodeHelper;
...
public class Demo_Sqlite_TestActivity extends Activity {
	...
	launchTest.setOnClickListener(new OnClickListener() {
		...
		// empDb.open();
		// // Toast.makeText(c, empDb.count()+" employes enregistres",
		...
		// Toast.makeText(c, "nb: "+l.size(),
		// Toast.LENGTH_SHORT).show();
		// empDb.close();

		// ArticleDbAdapter artDb = new ArticleDbAdapter(c);
		// artDb.open();
		// Toast.makeText(c, artDb.count()+" articles enregistres",
		// Toast.LENGTH_SHORT).show();
...
//		BarcodeHelper barcodeBdd = new BarcodeHelper(
//			Demo_Sqlite_TestActivity.this);
//		barcodeBdd.open();
//		Toast.makeText(c,
//			barcodeBdd.countBarcode() + " barcode enregistres",
//			Toast.LENGTH_SHORT).show();
		// Barcode b =
		// barcodeBdd.getBarcodeWithValue(barcode.getValue());
		// if (b != null) {
