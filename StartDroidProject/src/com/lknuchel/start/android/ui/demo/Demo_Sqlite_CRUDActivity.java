...
import com.lknuchel.start.android.io.sqlite.DbConstants;
import com.lknuchel.start.android.io.sqlite.KeyValueHelper;
...
public class Demo_Sqlite_CRUDActivity extends Activity {
	...
	a = Demo_Sqlite_CRUDActivity.this;
	c = getApplicationContext();
	setUp();
	onCLickValidate();
	displayList();
	Dialog.display(a, getResources().getString(R.string.DSCA_tuto));
    }
