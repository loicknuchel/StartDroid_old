...
import com.lknuchel.android.startdroidfull.ui.widget.ActionBar;
import com.lknuchel.android.startdroidfull.ui.widget.ActionBar.Action;
import com.lknuchel.android.startdroidfull.ui.widget.ActionBar.IntentAction;
import com.lknuchel.android.startdroidfull.util.ExtraIntent;
...
public class Demo_ActionBar_MainActivity extends Activity {
	...
	remove_last_action.setOnClickListener(new OnClickListener() {
		...
		Toast.makeText(Demo_ActionBar_MainActivity.this,
			getResources().getString(R.string.ABHA_remove),
	...
	add_new_action.setOnClickListener(new OnClickListener() {
		...
		actionBar.addAction(new Action() {
			...
			Toast.makeText(Demo_ActionBar_MainActivity.this,
				getResources().getString(R.string.ABHA_add),
				Toast.LENGTH_SHORT).show();
		    }
