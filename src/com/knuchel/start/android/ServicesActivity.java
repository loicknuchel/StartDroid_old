	...
	private void onCLickValidate(){
		serviceScan.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
            	ExtraService.scan(getApplicationContext(), ServicesActivity.this, Config.SCANNER_CODE);
            }
		});
	}
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		if (requestCode == Config.SCANNER_CODE) {
			if (resultCode == RESULT_OK) {
				...
				Popup.display(getApplicationContext(), ServicesActivity.this, "Scanner result", "format:"+format+"\ncontent:"+content);
			}
			else{
				Popup.display(getApplicationContext(), ServicesActivity.this, "Scanner result", "Scan annulé");
			}
		}
	}
}
